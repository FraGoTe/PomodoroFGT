...
(function () {
    ...
    app.onactivated = function (args) {
        if (args.detail.kind === activation.ActivationKind.launch) {
            ...
            var editButton = document.getElementById("editTask");
            var deleteButton = document.getElementById("deleteTask");

            addButton.addEventListener("click", faddTask, false);
            addButton.addEventListener("click", feditTask, false);
            addButton.addEventListener("click", fdeleteTask, false);
        }
    };
    ...
    /*function addTask() {
        var dlg = new Windows.UI.Popups.MessageDialog('Agregar!', 'Title');
        dlg.showAsync();
        dlg.done();
        ...
        */
        ...
        function faddTask() {
            showFlyout(confirmFlyout, addTask, "top");
        }
